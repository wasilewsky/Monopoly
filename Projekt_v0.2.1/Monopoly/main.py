...
class System:
    ...
    def create_game(self, c):
        ...
        self.message = Message()
        self.dice = Dice()
        self.game_board = Board(40, 40, screen)
            ...
            if field.mouse_on_field() and field.typ == 'POLE':
                ...
                if field.cena == 200 and field.czynsz == 25:  # Tylko satelity kosztuja 200 i maja czynsz 20
                    ...
                    for att in gm.data[0]:
                        if att not in ['typ', 'cena', 'czynsz z 3', 'czynsz z 4', 'czynsz z hotelem', 'koszt domu',
                                       'koszt hotelu', 'kolor', 'nazwa', 'hipoteka', 'splata hipoteki']:
    ...
    def ai_actions(self):
        if self.current_player_index != 0:
            ...
            self.message.add_message(f"gracz {self.players[self.current_player_index].name} poruszył się o {self.dice.show_turn_value()}")
