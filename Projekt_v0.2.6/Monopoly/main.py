...
def color():
    ...
    blueBtn = Button(screen.get_width() / 2 - gm.BLUEBTN.get_width() / 2, 330, gm.BLUEBTN)
    greenBtn = Button(screen.get_width() / 2 - gm.GREENBTN.get_width() / 2, 480, gm.GREENBTN)
    purpleBtn = Button(screen.get_width() / 2 - gm.PURPLEBTN.get_width() / 2, 630, gm.PURPLEBTN)
