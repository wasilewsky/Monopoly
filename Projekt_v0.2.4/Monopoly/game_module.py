...
chance_cards = (
    ...
    (2, 'IDŹ NA RÓŻOWE POLE 1. JEŻELI MINIESZ POLE START, POBIERZ $200.'),
    (3, 'IDŹ NA NAJBLIŻSZE POLE SATELITY.'),
    (4, 'IDŹ NA CZERWONE POLE 3. JEŻELI MINIESZ POLE START, POBIERZ $200.'),
    (5, 'WYJDŹ BEZPŁATNIE Z WIĘZIENIA.'),
    (6, 'IDŹ NA POLE SATELITY 1. JEŻELI MINIESZ POLE START, POBIERZ $200.'),
    (7, 'IDŹ NA NAJBLIŻSZE POLE ELEKTROWNI.'),
    (8, 'WYBRANO CIĘ PREZESEM ZARZĄDU. ZAPŁAĆ KAŻDEMU $50.'),
    (9, 'COFNIJ SIĘ O TRZY POLA.'),
    (10, 'BANK WYPŁACA CI DYWIDENDĘ W WYSOKOŚCI $50.'),
    (11, 'ZAPŁAĆ ZA KAŻDY DOM $25, A ZA KAŻDY HOTEL $100.'),
    (12, 'IDŹ DO WIĘZIENIA. NIE POBIERASZ $200.'),
    (13, 'IDŻ NA GRANATOWE POLE 2.'),
    (14, 'MANDAT ZA PRZEKROCZENIE PRĘDKOŚCI. OPŁATA $15.'),
    (15, 'OTRZYMUJESZ SPŁATĘ KREDYTU BUDOWLANEGO. POBIERZ $150.'),
